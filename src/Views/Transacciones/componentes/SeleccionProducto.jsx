  ...
  return (
    <div className="transacciones">
      ...
      <div className="product-selection">
        <button onClick={() => cambiarProducto("prev")} className="arrow-btn">
          ←
        </button>
        <img
          className="product-selection-image"
          src={productos[selectedProduct].imagen}
          alt={productos[selectedProduct].name}
        />
        <button onClick={() => cambiarProducto("next")} className="arrow-btn">
          →
        </button>
      </div>
